...
const translations = {
  ja: {
    ...
    feature1Desc: "ラカーサホテルから徒歩30秒。K-POPアイドルと同じレコーディングスタジオで主人公になってみませんか？",
  ...
  ko: {
    ...
    feature1Desc: "라까사호텔에서 도보 30초. K-POP 아이돌과 같은 레코딩 스튜디오에서 주인공이 되어보세요.",
    ...
    visitDesc: "라까사호텔 정문에서 아래 방향으로 30초 걸어주세요. 왼쪽에 대능빌딩이 보이면 2층으로 올라오세요.",
  ...
  zh: {
    langLabel: "中文",
    langFlag: "🇨🇳",
    hotelSubtitle: "距离La Casa酒店步行30秒",
    ...
    feature1Desc: "距离La Casa酒店步行30秒。在与K-POP偶像相同的录音室成为主角吧！",
    ...
    visitTitle: "访问",
    visitTitleHighlight: "方法",
    visitDesc: "从La Casa酒店正门向下走30秒。看到左侧的大能大厦后上2楼。",
  ...
  en: {
    langLabel: "English",
    langFlag: "🇺🇸",
    hotelSubtitle: "30 seconds walk from La Casa Hotel",
    ...
    feature1Desc: "30 seconds from La Casa Hotel. Become the star in the same recording studio as K-POP idols!",
    ...
    visitDesc: "Walk down 30 seconds from La Casa Hotel main gate. Go up to 2nd floor when you see Daeneung Building on your left.",
    address: "2F, 21, Gangnam-daero 107-gil, Seocho-gu, Seoul",
    ...
    ctaDesc: "30 seconds from La Casa Hotel\nDon't miss it during your stay",
    formTitle: "La Casa Hotel",
...
export default function LaCasaPage({ showBookingForm = true }: RiverPageProps) {
